...
# Final User Data Restoration using Django
echo "🔄 Restoring user data using Django management commands (final version)..."
...
for user_data in users_data:
    ...
    if created:
        ...
        # Create user profile with correct fields
...
echo "   Username: [any username from above]"
